...
export function Features() {
  ...
  return (
    <section
      ref={ref}
      id="features"
      className={cn("w-full py-32 transition-all duration-600 ease-out border-t border-white/10 bg-gradient-to-b from-[#020617] to-[#0B1120]", inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5")}
    >
