...
export function TaxSimulator() {
  ...
  return (
    <section
      ...
      id="simulator"
      className={cn(
        "w-full py-24 transition-all duration-600 ease-out bg-[#111111]",
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
              <div className="text-center">
                <h3 className="font-semibold text-muted-foreground mb-2">Impôt Société (Standard ~25%)</h3>
            ...
            <div className="text-center pt-6 bg-black/20 rounded-lg p-8 mt-4">
                <h3 className="text-xl text-muted-foreground mb-4">Capital Préservé par an :</h3>
